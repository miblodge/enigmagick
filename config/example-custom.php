<?php	
	...
	// Theme to use
	//if(!defined('ENIGMA_THEME')) DEFINE('ENIGMA_THEME', 'theme_two');
	...
	if(!defined('ENIGMA_ADVANCED')) DEFINE('ENIGMA_ADVANCED', true); // Best not to enable unless you've added custom texts
